...
class ReceipeVC: UIViewController {
    ...
    private var simplefood_LST = ["Mayo pav","Dhai puri","Citrus Fizz","Pom Blood orange"]
    private var simplefood_Abt = ["Cheeze mayo-pav","Sweet dhai puri","Fizzy citrus","Dynamite Pom blood orange"]
