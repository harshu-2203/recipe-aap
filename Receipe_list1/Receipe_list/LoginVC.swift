...
class LoginVC: UIViewController {
    ...
    private let bgimage: UIImageView = {
        ...
        bgimage.image = UIImage(named: "bg.jpg")
        return bgimage
    }()
    
    private let label :UILabel = {
        let label = UILabel()
        let font : UIFont = UIFont.boldSystemFont(ofSize: 70)
        label.font = .boldSystemFont(ofSize: 30)
        label.text = "ENJOY TO EAT"
    ...
    private let username : UITextField = {
        ...
        textView.placeholder = "Enter Customer id"
    ...
    private let vcbutton : UIButton = {
        ...
        vc_button.layer.cornerRadius = 70
        return vc_button
    } ()
